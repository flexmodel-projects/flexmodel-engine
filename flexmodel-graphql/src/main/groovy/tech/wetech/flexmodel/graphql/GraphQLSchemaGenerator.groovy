...
class GraphQLSchemaGenerator extends AbstractModelListGenerator {
  ...
  def generate(PrintWriter out, ModelListGenerationContext context) {
    ...
    out.println ""
    // gen query
    out.println "\"${MessageUtil.getString("gql.query.comment")}\""
    out.println "type Query {"
    context.modelListClass.modelList.each {
      def key = "${it.schemaName}_${it.modelName}"
      out.println ""
      out.println " \"${MessageUtil.getString("gql.query.find.comment", it.schemaName, it.modelName)}\""
      ...
      out.println "  ): [${key}!]!"
      out.println ""
      out.println "  \"${MessageUtil.getString("gql.query.aggregate.comment", it.schemaName, it.modelName)}\""
      ...
      out.println ""
      out.println "  \"${MessageUtil.getString("gql.query.find_one.comment", it.schemaName, it.modelName)}\""
    ...
    // gen mutation
    out.println ""
    out.println "\"${MessageUtil.getString("gql.mutation.comment")}\""
    out.println "type Mutation {"
    context.modelListClass.modelList.each {
      def key = "${it.schemaName}_${it.modelName}"
      out.println ""
      out.println "  \"${MessageUtil.getString("gql.mutation.delete.comment", it.schemaName, it.modelName)}\""
      ...
      if (it.idField) {
        out.println ""
        out.println "  \"${MessageUtil.getString("gql.mutation.delete_by_id.comment", it.schemaName, it.modelName)}\""
        out.println "  ${DataFetchers.MUTATION_DELETE_BY_ID.keyFunc.apply(it.schemaName, it.modelName)}("
        out.println "    id: ID!"
        out.println "  ): ${key}"
        out.println ""
        out.println "  \"${MessageUtil.getString("gql.mutation.update_by_id.comment", it.schemaName, it.modelName)}\""
      ...
      out.println ""
      out.println "  \"${MessageUtil.getString("gql.mutation.create.comment", it.schemaName, it.modelName)}\""
      out.println "  ${DataFetchers.MUTATION_CREATE.keyFunc.apply(it.schemaName, it.modelName)}("
      out.println "    data: ${key}_insert_input"
      out.println "  ): ${key}"
      out.println ""
      out.println "  \"${MessageUtil.getString("gql.mutation.update.comment", it.schemaName, it.modelName)}\""
    ...
    context.modelListClass.modelList.each {
      def key = "${it.schemaName}_${it.modelName}"
      out.println "  \"${MessageUtil.getString("gql.type.model.comment", it.schemaName, it.modelName)}\""
      ...
      out.println "}"
      out.println ""
      "\"${MessageUtil.getString("gql.query.aggregate.selection.comment", key)}\""
    ...
    out.println "}"
    out.println ""
    out.println "\"${MessageUtil.getString("gql.mutation.response.comment")}\""
