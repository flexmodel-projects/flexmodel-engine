...
class GraphQLSchemaGenerator extends AbstractModelListGenerator {
  ...
  def generate(PrintWriter out, ModelListGenerationContext context) {
    ...
    out.println "}"
    out.println ""
    out.println "\"Boolean expression to compare columns of type \\\"Long\\\". All fields are combined with logical 'AND.'\""
    ...
    out.println "}"
    out.println ""
    out.println "\"Boolean expression to compare columns of type \\\"Float\\\". All fields are combined with logical 'AND.'\""
    ...
    out.println "}"
    out.println ""
    out.println "\"Boolean expression to compare columns of type \\\"JSON\\\". All fields are combined with logical 'AND.'\""
    ...
    out.println "}"
    out.println ""
    out.println "\"Boolean expression to compare columns of type \\\"Boolean\\\". All fields are combined with logical 'AND.'\""
    out.println "input Boolean_comparison_exp {"
    out.println "  _eq: Boolean"
    out.println "  _ne: Boolean"
    out.println "}"
    out.println ""
    out.println "\"Boolean expression to compare columns of type \\\"Date\\\". All fields are combined with logical 'AND.'\""
    ...
    out.println "}"
    out.println ""
    out.println "\"Boolean expression to compare columns of type \\\"DateTime\\\". All fields are combined with logical 'AND.'\""
