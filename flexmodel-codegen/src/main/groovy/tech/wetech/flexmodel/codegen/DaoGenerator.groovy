...
class DaoGenerator extends AbstractGenerator {
  ...
  def generate(GroovyPrintWriter out, className, GenerationContext context) {
    ...
    out.println "import tech.wetech.flexmodel.*;"
    ...
    out.println "  @Inject"
    out.println "  SessionFactory sessionFactory;"
    out.println ""
    out.println "  // Schema name used for the database operations"
    out.println "  private String schemaName = \"System\";"
    out.println "  // Model name associated with the API info data"
    out.println "  private String modelName = \"ApiInfo\";"
    out.println "  // Field name used for identifying records"
    out.println "  private String idFieldName = \"${modelClass.idField.fieldName}\";"
    out.println ""
    ...
    out.println "    JsonObjectConverter jsonObjectConverter = sessionFactory.getJsonObjectConverter();"
    ...
    out.println "  /**"
    out.println "   * Updates an {@link ${modelClass.shortClassName}} record identified by its ID."
    out.println "   *"
    out.println "   * @param record The ${modelClass.shortClassName} record containing the updated values."
    ...
    out.println "  /**"
    out.println "   * Deletes an {@link ${modelClass.shortClassName}} record identified by its ID."
    out.println "   *"
    ...
    out.println "  /**"
    out.println "   * Finds an {@link ${modelClass.shortClassName}} record by its ID."
    out.println "   *"
    ...
    out.println "  /**"
    out.println "   * Finds an {@link ${modelClass.shortClassName}} record by its ID with an option for deep fetching."
    out.println "   *"
    out.println "   * @param id The ID of the record to find."
