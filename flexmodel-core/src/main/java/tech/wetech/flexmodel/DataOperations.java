...
public interface DataOperations {
  ...
  class DSLQueryBuilder {
    ...
    public DSLQueryBuilder select(UnaryOperator<Query.Projection> projectionUnaryOperator) {
      query.withProjection(projectionUnaryOperator);
      return this;
    }
    ...
    public DSLQueryBuilder orderBy(UnaryOperator<Query.Sort> sortUnaryOperator) {
      query.withSort(sortUnaryOperator);
      return this;
    }
    ...
    /**
     * 设置分页（使用 UnaryOperator）
     */
    public DSLQueryBuilder page(UnaryOperator<Query.Page> pageUnaryOperator) {
      query.withPage(pageUnaryOperator);
      return this;
    }
    ...
    public DSLQueryBuilder groupBy(UnaryOperator<Query.GroupBy> groupByUnaryOperator) {
      query.withGroupBy(groupByUnaryOperator);
      return this;
    }
    ...
    public DSLQueryBuilder join(UnaryOperator<Query.Joins> joinsUnaryOperator) {
      query.withJoin(joinsUnaryOperator);
      return this;
    }
     ...
     * 禁用嵌套查询
     */
    public DSLQueryBuilder disableNestedQuery() {
      query.disableNestedQuery();
      return this;
    }
