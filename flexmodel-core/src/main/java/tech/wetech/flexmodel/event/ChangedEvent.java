...
public abstract class ChangedEvent extends BaseEvent {
  ...
  protected ChangedEvent(EventType eventType, String modelName, String schemaName,
                         Map<String, Object> oldData, Map<String, Object> newData, Object id, int affectedRows,
                         boolean success, Throwable exception, String sessionId, SessionFactory source) {
