...
import tech.wetech.flexmodel.core.reflect.LazyObjProxy;
import tech.wetech.flexmodel.core.reflect.ReflectionUtils;
...
public abstract class AbstractSession implements Session {
    ...
    @Override
    public <T> List<T> findByNativeQueryStatement(String statement, Object params, Class<T> resultType) {
      return dataOperations.findByNativeQueryStatement(statement, params, resultType);
    }
